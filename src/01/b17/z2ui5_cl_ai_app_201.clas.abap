CLASS z2ui5_cl_ai_app_201 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_ai_app_201 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->open( n = `View` ns = `mvc`
            ...
            " element binding kept 1:1 - the context is the one-record structure instead of {/ProductCollection/0}
                ...
                )->a( n = `text` v = `{WEIGHT_MEASURE} {WEIGHT_UNIT} {WIDTH} x {DEPTH} x {HEIGHT} {DIM_UNIT}` ).
