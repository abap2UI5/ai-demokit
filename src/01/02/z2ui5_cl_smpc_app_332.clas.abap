" @keywords simpleform simple form sap.ui.layout.form simpleform480_trial bar button vbox title label text ratingindicator
...
CLASS z2ui5_cl_smpc_app_332 DEFINITION PUBLIC.
  ...
  PROTECTED SECTION.
    ...
    DATA backup_rating       TYPE i.
    DATA backup_disposable   TYPE i.
...
CLASS z2ui5_cl_smpc_app_332 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->ele( n = `View` ns = `mvc`
                ...
                " Display.fragment.xml
                        ...
                        )->a( n = `id`                      v = `SimpleFormDisplay480_Trial`
                                ...
                                )->a( n = `text` v = `Disposable`
                            )->tag( `ProgressIndicator`
                                )->a( n = `percentValue` v = client->_bind( disposable )
                                )->a( n = `displayOnly`  v = `true`
                ...
                " Change.fragment.xml
                        ...
                        )->a( n = `id`                      v = `SimpleFormChange480_Trial`
                        )->a( n = `editable`                v = `true`
                        )->a( n = `layout`                  v = `ResponsiveGridLayout`
                        )->a( n = `title`                   v = `Address`
                        )->a( n = `labelSpanXL`             v = `4`
