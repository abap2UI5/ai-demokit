" @keywords form sap.ui.layout.form form354widedual bar button vbox text input select
...
CLASS z2ui5_cl_smpc_app_314 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->ele( n = `View` ns = `mvc`
                ...
                " Display.fragment.xml
                        ...
                        )->a( n = `id`       v = `FormDisplay354wideDual`
                                        ...
                                        )->a( n = `label` v = `Web page of the contact`
                                        ...
                                        )->a( n = `label` v = `Twitter account of the contact`
                ...
                " Change.fragment.xml
                        ...
                        )->a( n = `id`       v = `FormChange354wideDual`
                        )->a( n = `editable` v = `true`
