" @keywords simpleform simple form sap.ui.layout.form simpleform480 bar button vbox title label text input
...
CLASS z2ui5_cl_smpc_app_329 IMPLEMENTATION.
