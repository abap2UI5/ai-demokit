CLASS z2ui5_cl_dmo_app_318 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_dmo_app_318 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->open( n = `View` ns = `mvc`
                ...
                " Display.fragment.xml
                        ...
                        )->a( n = `id`       v = `FormDisplay480_12120Dual`
                ...
                " Change.fragment.xml
                        ...
                        )->a( n = `id`       v = `FormChange480_12120Dual`
                        )->a( n = `editable` v = `true`
