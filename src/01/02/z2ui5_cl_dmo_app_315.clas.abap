CLASS z2ui5_cl_dmo_app_315 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_dmo_app_315 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->open( n = `View` ns = `mvc`
            ...
            )->a( n = `id`            v = `FormSplitscreen`
            )->a( n = `initialDetail` v = `page`
