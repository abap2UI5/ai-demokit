" @keywords simpleform simple form sap.ui.layout.form simpleform480_12120 bar button vbox label text input select
...
CLASS z2ui5_cl_smpc_app_330 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->ele( n = `View` ns = `mvc`
                ...
                " Display.fragment.xml
                        ...
                        )->a( n = `id`                      v = `SimpleFormDisplay480_12120`
                        ...
                        )->a( n = `id`                      v = `SimpleFormDisplay480_12120-2`
                        )->a( n = `editable`                v = `false`
                        )->a( n = `layout`                  v = `ResponsiveGridLayout`
                        )->a( n = `title`                   v = `More`
                        )->a( n = `labelSpanXL`             v = `4`
                ...
                " Change.fragment.xml
                        ...
                        )->a( n = `id`                      v = `SimpleFormChange480_12120`
                        )->a( n = `editable`                v = `true`
                        )->a( n = `layout`                  v = `ResponsiveGridLayout`
                        )->a( n = `title`                   v = `Address`
                        )->a( n = `labelSpanXL`             v = `4`
                        ...
                        )->a( n = `id`                      v = `SimpleFormChange480_12120-2`
                        )->a( n = `editable`                v = `true`
                        )->a( n = `layout`                  v = `ResponsiveGridLayout`
                        )->a( n = `title`                   v = `More`
                        )->a( n = `labelSpanXL`             v = `4`
