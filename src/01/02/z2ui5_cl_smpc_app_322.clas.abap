" @keywords form sap.ui.layout.form form_column_threegroups234 bar button vbox title columnlayout formcontainer formelement text link
" @summary Form with three groups in a fullscreen app (with 2 columns in M, 3 columns in L, and 4 columns in XL size).
CLASS z2ui5_cl_smpc_app_322 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smpc_app_322 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->ele( n = `View` ns = `mvc`
                ...
                " Display.fragment.xml
                        ...
                        )->a( n = `id`       v = `FormDisplayColumn_threeGroups234`
                ...
                " Change.fragment.xml
                        ...
                        )->a( n = `id`       v = `FormChangeColumn_threeGroups234`
                        )->a( n = `editable` v = `true`
