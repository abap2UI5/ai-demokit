" @keywords simpleform simple form sap.ui.layout.form simpleform354wide bar button vbox label text input select
...
CLASS z2ui5_cl_smpc_app_326 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->ele( n = `View` ns = `mvc`
                ...
                " Display.fragment.xml
                        ...
                        )->a( n = `id`                      v = `SimpleFormDisplay354wide`
                ...
                " Change.fragment.xml
                        ...
                        )->a( n = `id`                      v = `SimpleFormChange354wide`
                        )->a( n = `editable`                v = `true`
                        )->a( n = `layout`                  v = `ResponsiveGridLayout`
                        )->a( n = `title`                   v = `Address`
                        )->a( n = `labelSpanXL`             v = `4`
