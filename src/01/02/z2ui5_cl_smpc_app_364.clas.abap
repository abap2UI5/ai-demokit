" @keywords treetable tree table sap.ui.table treetable.basicodatatreebinding column label text
...
CLASS z2ui5_cl_smpc_app_364 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    view->ele( n = `View` ns = `mvc`
            ...
            )->a( n = `rows`                   v = |\{ path: '{ client->_bind_path( t_nodes ) }', parameters: \{ arrayNames: ['CHILDREN'] \} \}|
  ...
  METHOD model_init.
    ...
    DATA temp3 TYPE z2ui5_cl_smpc_app_364=>ty_t_node1.
    DATA temp4 LIKE LINE OF temp3.
    DATA temp9 TYPE z2ui5_cl_smpc_app_364=>ty_t_node2.
    DATA temp10 LIKE LINE OF temp9.
    DATA temp5 TYPE z2ui5_cl_smpc_app_364=>ty_t_node1.
    DATA temp6 LIKE LINE OF temp5.
    DATA temp7 TYPE z2ui5_cl_smpc_app_364=>ty_t_node1.
    DATA temp8 LIKE LINE OF temp7.
    DATA temp11 TYPE z2ui5_cl_smpc_app_364=>ty_t_node2.
    DATA temp12 LIKE LINE OF temp11.
    DATA temp13 TYPE z2ui5_cl_smpc_app_364=>ty_t_node3.
