" @keywords planningcalendar planning calendar sap.m planningcalendarwithstickyheader vbox title planningcalendarrow label multicombobox
...
CLASS z2ui5_cl_smpc_app_542 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    t_people = VALUE #(
      ...
      ( pic = `sap-icon://employee` name = `Nancy Davolio` role = `team member`
        t_appointments = VALUE #(
          ( start_at = `2017-01-15T10:00:00` end_at = `2017-01-15T10:30:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-17T10:00:00` end_at = `2017-01-17T12:00:00` title = `Team meeting` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-01-15T18:00:00` end_at = `2017-01-15T19:10:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-18T10:00:00` end_at = `2017-01-31T12:00:00` title = `Workshop out of the country` type = `Type07` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2018-01-01T00:00:00` end_at = `2018-03-31T23:59:00` title = `New quarter` type = `Type10` tentative = abap_false )
          ( start_at = `2017-02-11T10:00:00` end_at = `2017-03-20T12:00:00` title = `Team collaboration` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-04-01T10:00:00` end_at = `2017-05-01T12:00:00` title = `Workshop out of the country` type = `Type07` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-05-01T10:00:00` end_at = `2017-05-31T12:00:00` title = `Out of the office` type = `Type08` tentative = abap_false )
        ...
        t_headers = VALUE #(
          ( start_at = `2017-01-12T16:30:00` end_at = `2017-01-12T18:00:00` title = `Private appointment` type = `Type06` )
        )
      )
      ( pic = `sap-icon://employee` name = `Andrew Fuller` role = `team member`
        t_appointments = VALUE #(
          ( start_at = `2017-01-15T10:00:00` end_at = `2017-01-15T10:30:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-15T18:00:00` end_at = `2017-01-15T19:10:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-18T10:00:00` end_at = `2017-01-31T12:00:00` title = `Workshop out of the country` type = `Type07` pic = `sap-icon://sap-ui5` tentative = abap_false )
      ...
      ( pic = `sap-icon://employee` name = `Robert King` role = `team member`
        t_appointments = VALUE #(
          ( start_at = `2017-01-15T10:00:00` end_at = `2017-01-15T12:00:00` title = `Planning` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-17T10:00:00` end_at = `2017-01-17T12:00:00` title = `Team meeting` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-01-18T10:00:00` end_at = `2017-01-31T12:00:00` title = `Workshop out of the country` type = `Type07` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2018-01-01T00:00:00` end_at = `2018-03-31T23:59:00` title = `New quarter` type = `Type10` tentative = abap_false )
          ( start_at = `2017-02-11T10:00:00` end_at = `2017-03-20T12:00:00` title = `Team collaboration` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
      ...
      ( pic = `sap-icon://employee` name = `Janet Leverling` role = `team member`
        t_appointments = VALUE #(
          ( start_at = `2017-01-16T09:00:00` end_at = `2017-01-16T10:00:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-18T10:10:00` end_at = `2017-01-18T10:40:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-15T12:00:00` end_at = `2017-01-15T13:10:00` title = `Discussion` info = `Online meeting` type = `Type04` tentative = abap_true )
          ( start_at = `2017-01-18T10:00:00` end_at = `2017-01-31T12:00:00` title = `Workshop out of the country` type = `Type07` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-04-01T10:00:00` end_at = `2017-05-01T12:00:00` title = `Workshop out of the country` type = `Type07` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-05-01T10:00:00` end_at = `2017-05-31T12:00:00` title = `Out of the office` type = `Type08` tentative = abap_false )
        )
        t_headers = VALUE #(
          ( start_at = `2017-01-15T17:00:00` end_at = `2017-01-15T18:00:00` title = `Private appointment` type = `Type06` )
        )
      )
      ( pic = `sap-icon://employee` name = `Robert King` role = `team member`
        t_appointments = VALUE #(
      ...
      ( pic = `sap-icon://employee` name = `Laura Callahan` role = `team member`
        t_appointments = VALUE #(
          ( start_at = `2017-01-16T09:00:00` end_at = `2017-01-16T10:00:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-18T10:10:00` end_at = `2017-01-18T10:40:00` title = `Discussion of the plan` info = `Online meeting` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-15T12:00:00` end_at = `2017-01-15T13:10:00` title = `Discussion` info = `Online meeting` type = `Type04` tentative = abap_true )
      ...
      ( pic = `sap-icon://employee` name = `Anne Dodsworth` role = `team member`
        t_appointments = VALUE #(
          ( start_at = `2017-01-15T09:30:00` end_at = `2017-01-15T10:30:00` title = `Meeting` type = `Type02` tentative = abap_false )
          ( start_at = `2017-01-15T13:30:00` end_at = `2017-01-15T15:00:00` title = `Team meeting` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-01-17T00:00:00` end_at = `2017-01-17T23:59:00` title = `Vacation` info = `out of office` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-19T10:00:00` end_at = `2017-01-19T16:00:00` title = `Team meeting` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-01-22T07:00:00` end_at = `2017-01-27T17:30:00` title = `Discussion with clients` info = `out of office` type = `Type02` tentative = abap_false )
          ( start_at = `2017-03-13T09:00:00` end_at = `2017-03-17T10:00:00` title = `Payment week` type = `Type06` )
        )
      )
      ( pic = `sap-icon://employee` name = `Michael Suyama` role = `team member`
        t_appointments = VALUE #(
          ( start_at = `2017-01-15T09:00:00` end_at = `2017-01-15T10:30:00` title = `Meet new colleague` type = `Type02` tentative = abap_false )
          ( start_at = `2017-01-15T10:30:00` end_at = `2017-01-15T12:00:00` title = `Team meeting` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-01-15T15:00:00` end_at = `2017-01-15T16:00:00` title = `Discussion with clients` info = `online` type = `Type02` tentative = abap_false )
          ( start_at = `2017-01-17T00:00:00` end_at = `2017-01-17T23:59:00` title = `Vacation` info = `out of office` type = `Type04` tentative = abap_false )
          ( start_at = `2017-01-19T08:30:00` end_at = `2017-01-19T18:30:00` title = `Meet John Doe` type = `Type02` tentative = abap_false )
          ( start_at = `2017-01-19T10:00:00` end_at = `2017-01-19T16:00:00` title = `Team meeting` info = `room 1` type = `Type01` pic = `sap-icon://sap-ui5` tentative = abap_false )
          ( start_at = `2017-01-19T07:00:00` end_at = `2017-01-19T17:30:00` title = `Discussion with clients` type = `Type02` tentative = abap_false )
