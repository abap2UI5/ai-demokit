...
CLASS z2ui5_cl_smpc_app_565 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    t_products = VALUE #(
      ( product_id = `HT-1000` name = `Notebook Basic 15` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1000.jpg`
        weightmeasure = `4.2` weightunit = `KG` width = `30` depth = `18` height = `3` dimunit = `cm`
        description = `Notebook Basic 15 with 2,80 GHz quad core, 15" LCD, 4 GB DDR3 RAM, 500 GB Hard Disc, Windows 8 Pro` )
      ( product_id = `HT-1001` name = `Notebook Basic 17` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1001.jpg`
        weightmeasure = `4.5` weightunit = `KG` width = `29` depth = `17` height = `3.1` dimunit = `cm`
        description = `Notebook Basic 17 with 2,80 GHz quad core, 17" LCD, 4 GB DDR3 RAM, 500 GB Hard Disc, Windows 8 Pro` )
      ( product_id = `HT-1002` name = `Notebook Basic 18` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1002.jpg`
        weightmeasure = `4.2` weightunit = `KG` width = `28` depth = `19` height = `2.5` dimunit = `cm`
        description = `Notebook Basic 18 with 2,80 GHz quad core, 18" LCD, 8 GB DDR3 RAM, 1000 GB Hard Disc, Windows 8 Pro` )
      ( product_id = `HT-1003` name = `Notebook Basic 19` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1003.jpg`
        weightmeasure = `4.2` weightunit = `KG` width = `32` depth = `21` height = `4` dimunit = `cm`
        description = `Notebook Basic 19 with 2,80 GHz quad core, 19" LCD, 8 GB DDR3 RAM, 1000 GB Hard Disc, Windows 8 Pro` )
      ( product_id = `HT-1007` name = `ITelO Vault` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1007.jpg`
        weightmeasure = `0.2` weightunit = `KG` width = `32` depth = `22` height = `3` dimunit = `cm`
        description = `Digital Organizer with State-of-the-Art Storage Encryption` )
      ( product_id = `HT-1010` name = `Notebook Professional 15` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1010.jpg`
        weightmeasure = `4.3` weightunit = `KG` width = `33` depth = `20` height = `3` dimunit = `cm`
        description = `Notebook Professional 15 with 2,80 GHz quad core, 15" Multitouch LCD, 8 GB DDR3 RAM, 500 GB SSD - DVD-Writer (DVD-R/+R/-RW/-RAM),Windows 8 Pro` )
      ( product_id = `HT-1011` name = `Notebook Professional 17` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1011.jpg`
      ...
      ( product_id = `HT-1020` name = `ITelO Vault Net` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1020.jpg`
      ...
      ( product_id = `HT-1021` name = `ITelO Vault SAT` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1021.jpg`
      ...
      ( product_id = `HT-1022` name = `Comfort Easy` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1022.jpg`
        weightmeasure = `0.2` weightunit = `KG` width = `84` depth = `1.5` height = `14` dimunit = `cm`
        description = `32 GB Digital Assistant with high-resolution color screen` )
      ( product_id = `HT-1023` name = `Comfort Senior` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1023.jpg`
      ...
      ( product_id = `HT-1030` name = `Ergo Screen E-I` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1030.jpg`
        weightmeasure = `21` weightunit = `KG` width = `37` depth = `12` height = `36` dimunit = `cm`
        description = `Optimum Hi-Resolution max. 1920 x 1080 @ 85Hz, Dot Pitch: 0.27mm` )
      ( product_id = `HT-1031` name = `Ergo Screen E-II` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1031.jpg`
      ...
      ( product_id = `HT-1032` name = `Ergo Screen E-III` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1032.jpg`
        weightmeasure = `21` weightunit = `KG` width = `40.8` depth = `19` height = `43` dimunit = `cm`
        description = `Optimum Hi-Resolution max. 2560 x 1440 @ 85Hz, Dot Pitch: 0.25mm` )
      ( product_id = `HT-1035` name = `Flat Basic` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1035.jpg`
      ...
      ( product_id = `HT-1036` name = `Flat Future` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1036.jpg`
      ...
      ( product_id = `HT-1037` name = `Flat XL` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1037.jpg`
      ...
      ( product_id = `HT-1040` name = `Laser Professional Eco` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1040.jpg`
        weightmeasure = `32` weightunit = `KG` width = `51` depth = `46` height = `30` dimunit = `cm`
        description = `Print 2400 dpi image quality color documents at speeds of up to 32 ppm (color) or 36 ppm (monochrome), letter/A4. Powerful 500 MHz processor, 512MB of memory` )
      ( product_id = `HT-1041` name = `Laser Basic` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1041.jpg`
      ...
      ( product_id = `HT-1042` name = `Laser Allround` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1042.jpg`
      ...
      ( product_id = `HT-1050` name = `Ultra Jet Super Color` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1050.jpg`
      ...
      ( product_id = `HT-1051` name = `Ultra Jet Mobile` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1051.jpg`
      ...
      ( product_id = `HT-1052` name = `Ultra Jet Super Highspeed` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1052.jpg`
      ...
      ( product_id = `HT-1055` name = `Multi Print` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1055.jpg`
      ...
      ( product_id = `HT-1056` name = `Multi Color` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1056.jpg`
      ...
      ( product_id = `HT-1060` name = `Cordless Mouse` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1060.jpg`
      ...
      ( product_id = `HT-1061` name = `Speed Mouse` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1061.jpg`
      ...
      ( product_id = `HT-1062` name = `Track Mouse` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1062.jpg`
      ...
      ( product_id = `HT-1063` name = `Ergonomic Keyboard` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1063.jpg`
      ...
      ( product_id = `HT-1064` name = `Internet Keyboard` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1064.jpg`
      ...
      ( product_id = `HT-1065` name = `Media Keyboard` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1065.jpg`
      ...
      ( product_id = `HT-1066` name = `Mousepad` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1066.jpg`
        weightmeasure = `80` weightunit = `G` width = `15` depth = `6` height = `0.2` dimunit = `cm`
        description = `Nice mouse pad with ITelO Logo` )
      ( product_id = `HT-1067` name = `Ergo Mousepad` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1067.jpg`
        weightmeasure = `80` weightunit = `G` width = `15` depth = `6` height = `0.2` dimunit = `cm`
        description = `Ergonomic mouse pad with ITelO Logo` )
      ( product_id = `HT-1068` name = `Designer Mousepad` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1068.jpg`
        weightmeasure = `90` weightunit = `G` width = `24` depth = `24` height = `0.6` dimunit = `cm`
        description = `ITelO Mousepad Special Edition` )
      ( product_id = `HT-1069` name = `Universal card reader` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1069.jpg`
        weightmeasure = `45` weightunit = `G` width = `6` depth = `6` height = `3` dimunit = `cm`
        description = `Universal card reader` )
      ( product_id = `HT-1070` name = `Proctra X` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1070.jpg`
        weightmeasure = `0.255` weightunit = `KG` width = `22` depth = `35` height = `17` dimunit = `cm`
        description = `Proctra X: PCI-E GDDR5 3072MB` )
      ( product_id = `HT-1071` name = `Gladiator MX` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1071.jpg`
      ...
      ( product_id = `HT-1072` name = `Hurricane GX` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1072.jpg`
      ...
      ( product_id = `HT-1073` name = `Hurricane GX/LN` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1073.jpg`
        weightmeasure = `0.4` weightunit = `KG` width = `22` depth = `35` height = `17` dimunit = `cm`
        description = `Hurricane GX/LN: PCI-E 691 GFLOPS game-optimized, low-noise.` )
      ( product_id = `HT-1080` name = `Photo Scan` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1080.jpg`
      ...
      ( product_id = `HT-1081` name = `Power Scan` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1081.jpg`
      ...
      ( product_id = `HT-1082` name = `Jet Scan Professional` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1082.jpg`
      ...
      ( product_id = `HT-1083` name = `Jet Scan Professional` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1083.jpg`
      ...
      ( product_id = `HT-1085` name = `Copymaster` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1085.jpg`
        weightmeasure = `23.2` weightunit = `KG` width = `45` depth = `42` height = `22` dimunit = `cm`
        description = `Copymaster` )
      ( product_id = `HT-1090` name = `Surround Sound` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1090.jpg`
        weightmeasure = `3` weightunit = `KG` width = `12` depth = `10` height = `16` dimunit = `cm`
        description = `PC multimedia speakers - 5 Watt (Total)` )
      ( product_id = `HT-1091` name = `Blaster Extreme` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1091.jpg`
      ...
      ( product_id = `HT-1092` name = `Sound Booster` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1092.jpg`
      ...
      ( product_id = `HT-1095` name = `Lovely Sound 5.1 Wireless` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1095.jpg`
        weightmeasure = `80` weightunit = `G` width = `24` depth = `19` height = `23` dimunit = `cm`
        description = `5.1 Headset, 40 Hz-20 kHz, Wireless` )
      ( product_id = `HT-1096` name = `Lovely Sound 5.1` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1096.jpg`
        weightmeasure = `130` weightunit = `G` width = `25` depth = `17` height = `19` dimunit = `cm`
        description = `5.1 Headset, 40 Hz-20 kHz, 3m cable` )
      ( product_id = `HT-1097` name = `Lovely Sound Stereo` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1097.jpg`
        weightmeasure = `60` weightunit = `G` width = `21.3` depth = `2.4` height = `19.7` dimunit = `cm`
        description = `5.1 Headset, 40 Hz-20 kHz, 1m cable` )
      ( product_id = `HT-1100` name = `Smart Office` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1100.jpg`
      ...
      ( product_id = `HT-1101` name = `Smart Design` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1101.jpg`
      ...
      ( product_id = `HT-1102` name = `Smart Network` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1102.jpg`
      ...
      ( product_id = `HT-1103` name = `Smart Multimedia` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1103.jpg`
      ...
      ( product_id = `HT-1104` name = `Smart Games` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1104.jpg`
      ...
      ( product_id = `HT-1105` name = `Smart Internet Antivirus` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1105.jpg`
      ...
      ( product_id = `HT-1106` name = `Smart Firewall` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1106.jpg`
      ...
      ( product_id = `HT-1107` name = `Smart Money` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1107.jpg`
      ...
      ( product_id = `HT-1110` name = `PC Lock` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1110.jpg`
      ...
      ( product_id = `HT-1111` name = `Notebook Lock` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1111.jpg`
      ...
      ( product_id = `HT-1112` name = `Web cam reality` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1112.jpg`
        weightmeasure = `0.075` weightunit = `KG` width = `9` depth = `8.2` height = `1.3` dimunit = `cm`
        description = `Color webcam, color, High-Speed USB` )
      ( product_id = `HT-1113` name = `Screen clean` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1113.jpg`
        weightmeasure = `0.05` weightunit = `KG` width = `2` depth = `2` height = `0.1` dimunit = `cm`
        description = `10 separately packed screen wipes` )
      ( product_id = `HT-1114` name = `Fabric bag professional` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1114.jpg`
      ...
      ( product_id = `HT-1115` name = `Wireless DSL Router` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1115.jpg`
      ...
      ( product_id = `HT-1116` name = `Wireless DSL Router / Repeater` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1116.jpg`
        weightmeasure = `0.45` weightunit = `KG` width = `19.3` depth = `18` height = `5` dimunit = `cm`
        description = `Wireless DSL Router / Repeater (available in blue, black and silver)` )
      ( product_id = `HT-1117` name = `Wireless DSL Router / Repeater and Print Server` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1117.jpg`
        weightmeasure = `0.45` weightunit = `KG` width = `19.3` depth = `18` height = `5` dimunit = `cm`
        description = `Wireless DSL Router / Repeater and Print Server (available in blue, black and silver)` )
      ( product_id = `HT-1118` name = `USB Stick` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1118.jpg`
        weightmeasure = `0.015` weightunit = `KG` width = `1.5` depth = `8.7` height = `1.2` dimunit = `cm`
        description = `USB 2.0 High-Speed 64 GB` )
      ( product_id = `HT-1119` name = `Travel Adapter` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1119.jpg`
        weightmeasure = `88` weightunit = `G` width = `2` depth = `3.1` height = `3.9` dimunit = `cm`
        description = `Universal Travel Adapter` )
      ( product_id = `HT-1120` name = `Cordless Bluetooth Keyboard, english international` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1120.jpg`
      ...
      ( product_id = `HT-1137` name = `Flat XXL` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1137.jpg`
      ...
      ( product_id = `HT-1138` name = `Pocket Mouse` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1138.jpg`
      ...
      ( product_id = `HT-1210` name = `PC Power Station` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1210.jpg`
      ...
      ( product_id = `HT-1251` name = `Astro Laptop 1516` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1251.jpg`
        weightmeasure = `4.2` weightunit = `KG` width = `30` depth = `18` height = `3` dimunit = `cm`
        description = `Flexible Laptop with 2,5 GHz Quad Core, 15" HD TN, 16 GB DDR SDRAM, 256 GB SSD, Windows 10 Pro` )
      ( product_id = `HT-1252` name = `Astro Phone 6` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1252.jpg`
      ...
      ( product_id = `HT-1253` name = `Benda Laptop 1408` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1253.jpg`
        weightmeasure = `4.2` weightunit = `KG` width = `30` depth = `18` height = `3` dimunit = `cm`
        description = `Flexible Laptop with 2,5 GHz Dual Core, 14" HD+ TN, 8 GB DDR SDRAM, 324 GB SSD, Windows 10 Pro` )
      ( product_id = `HT-1254` name = `Bending Screen 21HD` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1254.jpg`
      ...
      ( product_id = `HT-1255` name = `Broad Screen 22HD` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1255.jpg`
      ...
      ( product_id = `HT-1256` name = `Cerdik Phone 7` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1256.jpg`
      ...
      ( product_id = `HT-1257` name = `Cepat Tablet 10.5` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1257.jpg`
      ...
      ( product_id = `HT-1258` name = `Cepat Tablet 8` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1258.jpg`
      ...
      ( product_id = `HT-1500` name = `Server Basic` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1500.jpg`
      ...
      ( product_id = `HT-1501` name = `Server Professional` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1501.jpg`
      ...
      ( product_id = `HT-1502` name = `Server Power Pro` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1502.jpg`
      ...
      ( product_id = `HT-1600` name = `Family PC Basic` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1600.jpg`
      ...
      ( product_id = `HT-1601` name = `Family PC Pro` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1601.jpg`
      ...
      ( product_id = `HT-1602` name = `Gaming Monster` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1602.jpg`
      ...
      ( product_id = `HT-1603` name = `Gaming Monster Pro` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-1603.jpg`
      ...
      ( product_id = `HT-2000` name = `7" Widescreen Portable DVD Player w MP3` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-2000.jpg`
      ...
      ( product_id = `HT-2001` name = `10" Portable DVD player` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-2001.jpg`
      ...
      ( product_id = `HT-2002` name = `Portable DVD Player with 9" LCD Monitor` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-2002.jpg`
      ...
      ( product_id = `HT-2025` name = `CD/DVD case: 264 sleeves` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-2025.jpg`
      ...
      ( product_id = `HT-2026` name = `Audio/Video Cable Kit - 4m` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-2026.jpg`
      ...
      ( product_id = `HT-2027` name = `Removable CD/DVD Laser Labels` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-2027.jpg`
      ...
      ( product_id = `HT-6100` name = `Beam Breaker B-1` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6100.jpg`
      ...
      ( product_id = `HT-6101` name = `Beam Breaker B-2` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6101.jpg`
        weightmeasure = `2` weightunit = `KG` width = `30.4` depth = `23.1` height = `23` dimunit = `cm`
        description = `1080p, DLP max.9,34 Meter, 2D-ready` )
      ( product_id = `HT-6102` name = `Beam Breaker B-3` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6102.jpg`
        weightmeasure = `2.5` weightunit = `KG` width = `30.4` depth = `23.1` height = `23` dimunit = `cm`
        description = `1080p, DLP max. 12,3 Meter, 3D-ready` )
      ( product_id = `HT-6110` name = `Play Movie` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6110.jpg`
      ...
      ( product_id = `HT-6111` name = `Record Movie` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6111.jpg`
      ...
      ( product_id = `HT-6120` name = `ITelo MusicStick` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6120.jpg`
        weightmeasure = `134` weightunit = `G` width = `1.5` depth = `6` height = `1` dimunit = `cm`
        description = `64 GB USB Music-on-Available-Stick` )
      ( product_id = `HT-6121` name = `ITelo Jog-Mate` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6121.jpg`
      ...
      ( product_id = `HT-6122` name = `Power Pro Player 40` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6122.jpg`
      ...
      ( product_id = `HT-6123` name = `Power Pro Player 80` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6123.jpg`
      ...
      ( product_id = `HT-6130` name = `Flat Watch HD32` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6130.jpg`
      ...
      ( product_id = `HT-6131` name = `Flat Watch HD37` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6131.jpg`
      ...
      ( product_id = `HT-6132` name = `Flat Watch HD41` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-6132.jpg`
      ...
      ( product_id = `HT-7000` name = `Copperberry` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-7000.jpg`
      ...
      ( product_id = `HT-7010` name = `Silverberry` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-7010.jpg`
        weightmeasure = `0.5` weightunit = `KG` width = `8.1` depth = `13` height = `12.1` dimunit = `cm`
        description = `Our new multifunctional Handheld with phone function in silver` )
      ( product_id = `HT-7020` name = `Goldberry` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-7020.jpg`
        weightmeasure = `0.5` weightunit = `KG` width = `8.1` depth = `13` height = `12.1` dimunit = `cm`
        description = `Our new multifunctional Handheld with phone function in gold` )
      ( product_id = `HT-7030` name = `Platinberry` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-7030.jpg`
        weightmeasure = `0.5` weightunit = `KG` width = `8.1` depth = `13` height = `12.1` dimunit = `cm`
        description = `Our new multifunctional Handheld with phone function in platinum` )
      ( product_id = `HT-8000` name = `ITelO FlexTop I4000` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-8000.jpg`
      ...
      ( product_id = `HT-8001` name = `ITelO FlexTop I6300c` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-8001.jpg`
      ...
      ( product_id = `HT-8002` name = `ITelO FlexTop I9100` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-8002.jpg`
      ...
      ( product_id = `HT-8003` name = `ITelO FlexTop I9800` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-8003.jpg`
      ...
      ( product_id = `HT-9991` name = `Smartphone Leather Case` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9991.jpg`
      ...
      ( product_id = `HT-9992` name = `Smartphone Alpha` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9992.jpg`
        weightmeasure = `0.75` weightunit = `KG` width = `48` depth = `31` height = `4.5` dimunit = `cm`
        description = `7 inch 1280x800 HD display (216 ppi), Quad-core processor, 16 GB internal storage (actual formatted capacity will be less), 4325 mAh battery (Up to 8 hours of active use), white or black` )
      ( product_id = `HT-9993` name = `Mini Tablet` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9993.jpg`
        weightmeasure = `3.8` weightunit = `KG` width = `48` depth = `31` height = `4.5` dimunit = `cm`
      ...
      ( product_id = `HT-9994` name = `Camcorder View` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9994.jpg`
      ...
      ( product_id = `HT-9995` name = `Tablet Pouch` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9995.jpg`
      ...
      ( product_id = `HT-9996` name = `Tablet Pouch` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9996.jpg`
        weightmeasure = `0.03` weightunit = `KG` width = `25` depth = `40` height = `4.5` dimunit = `cm`
        description = `Stylish tablet pouch, protects from scratches, color: black` )
      ( product_id = `HT-9997` name = `e-Book Reader ReadMe` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9997.jpg`
        weightmeasure = `3.8` weightunit = `KG` width = `48` depth = `31` height = `4.5` dimunit = `cm`
        description = `6-Inch E Ink Screen, Access To e-book Store, Adjustable Font Styles and Sizes, Stores Up To 1,000 Books` )
      ( product_id = `HT-9998` name = `Smartphone Beta` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9998.jpg`
        weightmeasure = `0.75` weightunit = `KG` width = `48` depth = `31` height = `4.5` dimunit = `cm`
        description = `5 Megapixel Camera, Wi-Fi 802.11 b/g/n, Bluetooth, GPS Available-GPS support` )
      ( product_id = `HT-9999` name = `Maxi Tablet` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/HT-9999.jpg`
        weightmeasure = `3.8` weightunit = `KG` width = `48` depth = `31` height = `4.5` dimunit = `cm`
      ...
      ( product_id = `PF-1000` name = `Flyer` productpicurl = `https://sdk.openui5.org/test-resources/sap/ui/documentation/sdk/images/PF-1000.jpg`
