CLASS z2ui5_cl_dmo_app_218 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_dmo_app_218 IMPLEMENTATION.
  ...
  METHOD model_init.
    ...
    t_products = VALUE #(
        ( productid = `HT-1000` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `4.2` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1000.jpg` status = `Available` quantity = 10 uom = `PC` currencycode = `EUR` price = `956` width = `30` depth = `18` height = `3` dimunit = `cm` )
        ( productid = `HT-1001` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `4.5` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1001.jpg` status = `Available` quantity = 20 uom = `PC` currencycode = `EUR` price = `1249` width = `29` depth = `17` height = `3.1` dimunit = `cm` )
        ( productid = `HT-1002` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `4.2` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1002.jpg` status = `Available` quantity = 10 uom = `PC` currencycode = `EUR` price = `1570` width = `28` depth = `19` height = `2.5` dimunit = `cm` )
        ( productid = `HT-1003` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Smartcards` weightmeasure = `4.2` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1003.jpg` status = `Out of Stock` quantity = 15 uom = `PC` currencycode = `EUR` price = `1650` width = `32` depth = `21` height = `4` dimunit = `cm` )
        ( productid = `HT-1007` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.2` weightunit = `KG`
          description = `Digital Organizer with State-of-the-Art Storage Encryption` name = `ITelO Vault` dateofsale = `2017-05-17` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1007.jpg` status = `Out of Stock` quantity = 15
        ...
        ( productid = `HT-1010` category = `Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `4.3` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1010.jpg` status = `Out of Stock` quantity = 16 uom = `PC` currencycode = `EUR` price = `1999` width = `33` depth = `20` height = `3` dimunit = `cm` )
        ( productid = `HT-1011` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `4.1` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1011.jpg` status = `Out of Stock` quantity = 17 uom = `PC` currencycode = `EUR` price = `2299` width = `33` depth = `23` height = `2` dimunit = `cm` )
        ( productid = `HT-1020` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.16` weightunit = `KG`
          description = `Digital Organizer with State-of-the-Art Encryption for Storage and Network Communications` name = `ITelO Vault Net` dateofsale = `2017-05-08` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1020.jpg`
        ...
        ( productid = `HT-1021` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.18` weightunit = `KG`
          description = `Digital Organizer with State-of-the-Art Encryption for Storage and Secure Stellite Link` name = `ITelO Vault SAT` dateofsale = `2017-06-30` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1021.jpg`
        ...
        ( productid = `HT-1022` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.2` weightunit = `KG`
          description = `32 GB Digital Assistant with high-resolution color screen` name = `Comfort Easy` dateofsale = `2017-03-02` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1022.jpg` status = `Out of Stock` quantity = 30
        ...
        ( productid = `HT-1023` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.8` weightunit = `KG`
          description = `64 GB Digital Assistant with high-resolution color screen and synthesized voice output` name = `Comfort Senior` dateofsale = `2017-02-25` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1023.jpg`
        ...
        ( productid = `HT-1030` category = `Flat Screen Monitors` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `21` weightunit = `KG`
          description = `Optimum Hi-Resolution max. 1920 x 1080 @ 85Hz, Dot Pitch: 0.27mm` name = `Ergo Screen E-I` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1030.jpg` status = `Available` quantity = 14
        ...
        ( productid = `HT-1031` category = `Flat Screen Monitors` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `21` weightunit = `KG`
          description = `Optimum Hi-Resolution max. 1920 x 1200 @ 85Hz, Dot Pitch: 0.26mm` name = `Ergo Screen E-II` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1031.jpg` status = `Available` quantity = 24
        ...
        ( productid = `HT-1032` category = `Flat Screen Monitors` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `21` weightunit = `KG`
          description = `Optimum Hi-Resolution max. 2560 x 1440 @ 85Hz, Dot Pitch: 0.25mm` name = `Ergo Screen E-III` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1032.jpg` status = `Out of Stock` quantity = 50
        ...
        ( productid = `HT-1035` category = `Flat Screen Monitors` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `14` weightunit = `KG`
          description = `Optimum Hi-Resolution max. 1600 x 1200 @ 85Hz, Dot Pitch: 0.24mm` name = `Flat Basic` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1035.jpg` status = `Available` quantity = 23 uom = `PC`
        ...
        ( productid = `HT-1036` category = `Flat Screen Monitors` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `15` weightunit = `KG`
          description = `Optimum Hi-Resolution max. 2048 x 1080 @ 85Hz, Dot Pitch: 0.26mm` name = `Flat Future` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1036.jpg` status = `Available` quantity = 22 uom = `PC`
        ...
        ( productid = `HT-1037` category = `Flat Screen Monitors` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `17` weightunit = `KG`
          description = `Optimum Hi-Resolution max. 2016 x 1512 @ 85Hz, Dot Pitch: 0.24mm` name = `Flat XL` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1037.jpg` status = `Available` quantity = 23 uom = `PC`
        ...
        ( productid = `HT-1040` category = `Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Alpha Printers` weightmeasure = `32` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1040.jpg` status = `Available` quantity = 21 uom = `PC` currencycode = `EUR` price = `830` width = `51` depth = `46` height = `30` dimunit = `cm` )
        ( productid = `HT-1041` category = `Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Alpha Printers` weightmeasure = `23` weightunit = `KG`
          description = `Up to 22 ppm color or 24 ppm monochrome A4/letter, powerful 500 MHz processor and 128MB of memory` name = `Laser Basic` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1041.jpg`
        ...
        ( productid = `HT-1042` category = `Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Alpha Printers` weightmeasure = `17` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1042.jpg` status = `Available` quantity = 9 uom = `PC` currencycode = `EUR` price = `349` width = `53` depth = `50` height = `65` dimunit = `cm` )
        ( productid = `HT-1050` category = `Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Alpha Printers` weightmeasure = `3` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1050.jpg` status = `Discontinued` quantity = 17 uom = `PC` currencycode = `EUR` price = `139` width = `41` depth = `41` height = `28` dimunit = `cm` )
        ( productid = `HT-1051` category = `Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `1.9` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1051.jpg` status = `Discontinued` quantity = 18 uom = `PC` currencycode = `EUR` price = `99` width = `46` depth = `32` height = `25` dimunit = `cm` )
        ( productid = `HT-1052` category = `Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `18` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1052.jpg` status = `Available` quantity = 25 uom = `PC` currencycode = `EUR` price = `170` width = `41` depth = `41` height = `28` dimunit = `cm` )
        ( productid = `HT-1055` category = `Multifunction Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `6.3` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1055.jpg` status = `Available` quantity = 16 uom = `PC` currencycode = `EUR` price = `99` width = `55` depth = `45` height = `29` dimunit = `cm` )
        ( productid = `HT-1056` category = `Multifunction Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `4.3` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1056.jpg` status = `Available` quantity = 5 uom = `PC` currencycode = `EUR` price = `119` width = `51` depth = `41.3` height = `22` dimunit = `cm` )
        ( productid = `HT-1060` category = `Mice` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `0.09` weightunit = `KG` description = `Cordless Optical USB Mice, Laptop, Color: Black, Plug&Play`
          name = `Cordless Mouse` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1060.jpg` status = `Available` quantity = 25 uom = `PC` currencycode = `EUR` price = `9` width = `6` depth = `14.5` height = `3.5`
          dimunit = `cm` )
        ( productid = `HT-1061` category = `Mice` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `0.09` weightunit = `KG`
          description = `Optical USB, PS/2 Mouse, Color: Blue, 3-button-functionality (incl. Scroll wheel)` name = `Speed Mouse` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1061.jpg` status = `Available`
        ...
        ( productid = `HT-1062` category = `Mice` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `0.03` weightunit = `KG`
          description = `Optical USB Mouse, Color: Red, 5-button-functionality(incl. Scroll wheel), Plug&Play` name = `Track Mouse` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1062.jpg` status = `Discontinued`
        ...
        ( productid = `HT-1063` category = `Keyboards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `2.1` weightunit = `KG` description = `Ergonomic USB Keyboard for Desktop, Plug&Play`
          name = `Ergonomic Keyboard` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1063.jpg` status = `Available` quantity = 50 uom = `PC` currencycode = `EUR` price = `14` width = `50` depth = `21`
        ...
        ( productid = `HT-1064` category = `Keyboards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `1.8` weightunit = `KG`
          description = `Corded Keyboard with special keys for Internet Usability, USB` name = `Internet Keyboard` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1064.jpg` status = `Out of Stock` quantity = 35
        ...
        ( productid = `HT-1065` category = `Keyboards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `2.3` weightunit = `KG`
          description = `Corded Ergonomic Keyboard with special keys for Media Usability, USB` name = `Media Keyboard` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1065.jpg` status = `Available` quantity = 26
        ...
        ( productid = `HT-1066` category = `Mousepads` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `80` weightunit = `G` description = `Nice mouse pad with ITelO Logo` name = `Mousepad`
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1066.jpg` status = `Available` quantity = 12 uom = `PC` currencycode = `EUR` price = `6.99` width = `15` depth = `6` height = `0.2` dimunit = `cm` )
        ( productid = `HT-1067` category = `Mousepads` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Oxynum` weightmeasure = `80` weightunit = `G` description = `Ergonomic mouse pad with ITelO Logo` name = `Ergo Mousepad`
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1067.jpg` status = `Out of Stock` quantity = 16 uom = `PC` currencycode = `EUR` price = `8.99` width = `15` depth = `6` height = `0.2` dimunit = `cm` )
        ( productid = `HT-1068` category = `Mousepads` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `90` weightunit = `G` description = `ITelO Mousepad Special Edition` name = `Designer Mousepad`
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1068.jpg` status = `Available` quantity = 26 uom = `PC` currencycode = `EUR` price = `12.99` width = `24` depth = `24` height = `0.6` dimunit = `cm` )
        ( productid = `HT-1069` category = `Computer System Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `45` weightunit = `G` description = `Universal card reader`
          name = `Universal card reader` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1069.jpg` status = `Available` quantity = 22 uom = `PC` currencycode = `EUR` price = `14` width = `6` depth = `6` height = `3`
          dimunit = `cm` )
        ( productid = `HT-1070` category = `Graphic Cards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `0.255` weightunit = `KG` description = `Proctra X: PCI-E GDDR5 3072MB`
          name = `Proctra X` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1070.jpg` status = `Out of Stock` quantity = 15 uom = `PC` currencycode = `EUR` price = `70.9` width = `22` depth = `35` height = `17`
          dimunit = `cm` )
        ( productid = `HT-1071` category = `Graphic Cards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `0.3` weightunit = `KG`
          description = `Gladiator XLN: PCI-E GDDR5 3072MB DVI Out, TV Out low-noise` name = `Gladiator MX` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1071.jpg` status = `Discontinued` quantity = 16 uom = `PC`
        ...
        ( productid = `HT-1072` category = `Graphic Cards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `0.4` weightunit = `KG`
          description = `Hurricane GX: PCI-E 691 GFLOPS game-optimized` name = `Hurricane GX` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1072.jpg` status = `Available` quantity = 13 uom = `PC`
        ...
        ( productid = `HT-1073` category = `Graphic Cards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Smartcards` weightmeasure = `0.4` weightunit = `KG`
          description = `Hurricane GX/LN: PCI-E 691 GFLOPS game-optimized, low-noise.` name = `Hurricane GX/LN` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1073.jpg` status = `Out of Stock` quantity = 5
        ...
        ( productid = `HT-1080` category = `Scanners` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `2.3` weightunit = `KG`
          description = `Flatbed scanner - 9.600 × 9.600 dpi - 216 x 297 mm - Hi-Speed USB - Bluetooth` name = `Photo Scan` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1080.jpg` status = `Out of Stock`
        ...
        ( productid = `HT-1081` category = `Scanners` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `2.4` weightunit = `KG`
          description = `Flatbed scanner - 9.600 × 9.600 dpi - 216 x 297 mm - SCSI for backward compatibility` name = `Power Scan` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1081.jpg` status = `Out of Stock`
        ...
        ( productid = `HT-1082` category = `Scanners` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `3.2` weightunit = `KG`
          description = `Flatbed scanner - Letter - 2400 dpi x 2400 dpi - 216 x 297 mm - add-on module` name = `Jet Scan Professional` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1082.jpg`
        ...
        ( productid = `HT-1083` category = `Scanners` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Printer for All` weightmeasure = `3.2` weightunit = `KG`
          description = `Flatbed scanner - A4 - 2400 dpi x 2400 dpi - 216 x 297 mm - add-on module` name = `Jet Scan Professional` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1083.jpg` status = `Available`
        ...
        ( productid = `HT-1085` category = `Multifunction Printers` maincategory = `Printers & Scanners` taxtarifcode = `1` suppliername = `Alpha Printers` weightmeasure = `23.2` weightunit = `KG` description = `Copymaster` name = `Copymaster`
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1085.jpg` status = `Available` quantity = 10 uom = `PC` currencycode = `EUR` price = `1499` width = `45` depth = `42` height = `22` dimunit = `cm` )
        ( productid = `HT-1090` category = `Speakers` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Speaker Experts` weightmeasure = `3` weightunit = `KG` description = `PC multimedia speakers - 5 Watt (Total)`
          name = `Surround Sound` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1090.jpg` status = `Available` quantity = 20 uom = `PC` currencycode = `EUR` price = `39` width = `12` depth = `10` height = `16`
          dimunit = `cm` )
        ( productid = `HT-1091` category = `Speakers` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Speaker Experts` weightmeasure = `1.4` weightunit = `KG` description = `PC multimedia speakers - 10 Watt (Total) - 2-way`
          name = `Blaster Extreme` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1091.jpg` status = `Available` quantity = 15 uom = `PC` currencycode = `EUR` price = `26` width = `13` depth = `11` height = `17.5`
          dimunit = `cm` )
        ( productid = `HT-1092` category = `Speakers` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Speaker Experts` weightmeasure = `2.1` weightunit = `KG`
          description = `PC multimedia speakers - optimized for Blutooth/A2DP` name = `Sound Booster` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1092.jpg` status = `Discontinued` quantity = 50 uom = `PC`
        ...
        ( productid = `HT-1095` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `80` weightunit = `G` description = `5.1 Headset, 40 Hz-20 kHz, Wireless`
          name = `Lovely Sound 5.1 Wireless` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1095.jpg` status = `Available` quantity = 12 uom = `PC` currencycode = `EUR` price = `49` width = `24` depth = `19`
        ...
        ( productid = `HT-1096` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `130` weightunit = `G` description = `5.1 Headset, 40 Hz-20 kHz, 3m cable`
          name = `Lovely Sound 5.1` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1096.jpg` status = `Available` quantity = 18 uom = `PC` currencycode = `EUR` price = `39` width = `25` depth = `17` height = `19`
          dimunit = `cm` )
        ( productid = `HT-1097` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `60` weightunit = `G` description = `5.1 Headset, 40 Hz-20 kHz, 1m cable`
          name = `Lovely Sound Stereo` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1097.jpg` status = `Out of Stock` quantity = 21 uom = `PC` currencycode = `EUR` price = `29` width = `21.3` depth = `2.4`
        ...
        ( productid = `HT-1100` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `1.2` weightunit = `KG`
          description = `Complete package, 1 User, Office Applications (word processing, spreadsheet, presentations)` name = `Smart Office` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1100.jpg`
        ...
        ( productid = `HT-1101` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.8` weightunit = `KG` description = `Complete package, 1 User, Image editing, processing`
          name = `Smart Design` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1101.jpg` status = `Available` quantity = 26 uom = `PC` currencycode = `EUR` price = `79.9` width = `14` depth = `6.7` height = `24`
          dimunit = `cm` )
        ( productid = `HT-1102` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.8` weightunit = `KG`
          description = `Complete package, 1 User, Network Software Utilities, Useful Applications and Documentation` name = `Smart Network` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1102.jpg`
        ...
        ( productid = `HT-1103` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.8` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1103.jpg` status = `Available` quantity = 9 uom = `PC` currencycode = `EUR` price = `77` width = `11` depth = `3.4` height = `22` dimunit = `cm` )
        ( productid = `HT-1104` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `1.1` weightunit = `KG`
          description = `Complete package, 1 User, various games for amusement, logic, action, jump&run` name = `Smart Games` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1104.jpg` status = `Available`
        ...
        ( productid = `HT-1105` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Brainsoft` weightmeasure = `0.7` weightunit = `KG`
          description = `Complete package, 1 User, highly recommended for internet users as anti-virus protection` name = `Smart Internet Antivirus` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1105.jpg`
        ...
        ( productid = `HT-1106` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Brainsoft` weightmeasure = `0.9` weightunit = `KG`
          description = `Complete package, 1 User, recommended for internet users, protect your PC against cyber-crime` name = `Smart Firewall` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1106.jpg`
        ...
        ( productid = `HT-1107` category = `Software` maincategory = `Software` taxtarifcode = `1` suppliername = `Brainsoft` weightmeasure = `0.5` weightunit = `KG`
          description = `Complete package, 1 User, bring your money in your mind, see what you have and what you want` name = `Smart Money` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1107.jpg`
        ...
        ( productid = `HT-1110` category = `Computer System Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Red Point Stores` weightmeasure = `0.03` weightunit = `KG`
          description = `Robust 3m anti-burglary protection for your laptop computer` name = `PC Lock` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1110.jpg` status = `Available` quantity = 14 uom = `PC`
        ...
        ( productid = `HT-1111` category = `Computer System Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Red Point Stores` weightmeasure = `0.02` weightunit = `KG`
          description = `Robust 1m anti-burglary protection for your desktop computer` name = `Notebook Lock` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1111.jpg` status = `Available` quantity = 20 uom = `PC`
        ...
        ( productid = `HT-1112` category = `Computer System Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Red Point Stores` weightmeasure = `0.075` weightunit = `KG`
          description = `Color webcam, color, High-Speed USB` name = `Web cam reality` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1112.jpg` status = `Out of Stock` quantity = 27 uom = `PC` currencycode = `EUR`
        ...
        ( productid = `HT-1113` category = `Computer System Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Red Point Stores` weightmeasure = `0.05` weightunit = `KG` description = `10 separately packed screen wipes`
          name = `Screen clean` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1113.jpg` status = `Available` quantity = 17 uom = `PC` currencycode = `EUR` price = `2.3` width = `2` depth = `2` height = `0.1`
          dimunit = `cm` )
        ( productid = `HT-1114` category = `Computer System Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Red Point Stores` weightmeasure = `1.8` weightunit = `KG`
          description = `Notebook bag, plenty of room for stationery and writing materials` name = `Fabric bag professional` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1114.jpg` status = `Available`
        ...
        ( productid = `HT-1115` category = `Telecommunications` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Red Point Stores` weightmeasure = `0.45` weightunit = `KG`
          description = `Wireless DSL Router (available in blue, black and silver)` name = `Wireless DSL Router` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1115.jpg` status = `Available` quantity = 16
        ...
        ( productid = `HT-1116` category = `Telecommunications` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Red Point Stores` weightmeasure = `0.45` weightunit = `KG`
          description = `Wireless DSL Router / Repeater (available in blue, black and silver)` name = `Wireless DSL Router / Repeater` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1116.jpg`
        ...
        ( productid = `HT-1117` category = `Telecommunications` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.45` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1117.jpg` status = `Available` quantity = 12 uom = `PC` currencycode = `EUR` price = `69` width = `19.3` depth = `18` height = `5` dimunit = `cm` )
        ( productid = `HT-1118` category = `Computer System Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.015` weightunit = `KG` description = `USB 2.0 High-Speed 64 GB`
          name = `USB Stick` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1118.jpg` status = `Available` quantity = 14 uom = `PC` currencycode = `EUR` price = `35` width = `1.5` depth = `8.7` height = `1.2`
          dimunit = `cm` )
        ( productid = `HT-1119` category = `Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `88` weightunit = `G` description = `Universal Travel Adapter` name = `Travel Adapter`
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1119.jpg` status = `Discontinued` quantity = 10 uom = `PC` currencycode = `EUR` price = `79` width = `2` depth = `3.1` height = `3.9` dimunit = `cm` )
        ( productid = `HT-1120` category = `Keyboards` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `1` weightunit = `KG` description = `Cordless Bluetooth Keyboard with English keys`
          name = `Cordless Bluetooth Keyboard, english international` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1120.jpg` status = `Out of Stock` quantity = 13 uom = `PC` currencycode = `EUR` price = `29`
        ...
        ( productid = `HT-1137` category = `Flat Screen Monitors` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `18` weightunit = `KG`
          description = `Optimum Hi-Resolution max. 2048 × 1536 @ 85Hz, Dot Pitch: 0.24mm` name = `Flat XXL` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1137.jpg` status = `Discontinued` quantity = 10 uom = `PC`
        ...
        ( productid = `HT-1138` category = `Mice` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.02` weightunit = `KG` description = `Portable pocket Mouse with retracting cord`
          name = `Pocket Mouse` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1138.jpg` status = `Available` quantity = 20 uom = `PC` currencycode = `EUR` price = `23` width = `0.3` depth = `0.5` height = `1`
          dimunit = `cm` )
        ( productid = `HT-1210` category = `PCs` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `2.3` weightunit = `KG`
          description = `PC Power Station with 3,4 Ghz quad-core, 32 GB DDR3 SDRAM, feels like Available PC, Windows 8 Pro` name = `PC Power Station` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1210.jpg`
        ...
        ( productid = `HT-1251` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `4.2` weightunit = `KG`
          description = `Flexible Laptop with 2,5 GHz Quad Core, 15" HD TN, 16 GB DDR SDRAM, 256 GB SSD, Windows 10 Pro` name = `Astro Laptop 1516` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1251.jpg`
        ...
        ( productid = `HT-1252` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `0.75` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1252.jpg` status = `Available` quantity = 28 uom = `PC` currencycode = `EUR` price = `649` width = `8` depth = `6` height = `1.5` dimunit = `cm` )
        ( productid = `HT-1253` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `4.2` weightunit = `KG`
          description = `Flexible Laptop with 2,5 GHz Dual Core, 14" HD+ TN, 8 GB DDR SDRAM, 324 GB SSD, Windows 10 Pro` name = `Benda Laptop 1408` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1253.jpg`
        ...
        ( productid = `HT-1254` category = `Flat Screens` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `15` weightunit = `KG`
          description = `Optimum Hi-Resolution Widescreen max. 1920 x 1080 @ 85Hz, Dot Pitch: 0.27mm, HDMI, Discontinued-Sub` name = `Bending Screen 21HD` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1254.jpg`
        ...
        ( productid = `HT-1255` category = `Flat Screens` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `16` weightunit = `KG`
          description = `Optimum Hi-Resolution Widescreen max. 2048 x 1080 @ 85Hz, Dot Pitch: 0.27mm, HDMI, Discontinued-Sub` name = `Broad Screen 22HD` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1255.jpg`
        ...
        ( productid = `HT-1256` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `0.75` weightunit = `KG`
          ...
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1256.jpg` status = `Discontinued` quantity = 19 uom = `PC` currencycode = `EUR` price = `549` width = `9` depth = `15` height = `1.5` dimunit = `cm` )
        ( productid = `HT-1257` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `2.8` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1257.jpg` status = `Available` quantity = 17 uom = `PC` currencycode = `EUR` price = `549` width = `48` depth = `31` height = `4.5` dimunit = `cm` )
        ( productid = `HT-1258` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `2.5` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1258.jpg` status = `Available` quantity = 24 uom = `PC` currencycode = `EUR` price = `529` width = `38` depth = `21` height = `3.5` dimunit = `cm` )
        ( productid = `HT-1500` category = `Servers` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `18` weightunit = `KG`
          description = `Dual socket, quad-core processing server with 1333 MHz Front Side Bus with 10Gb connectivity` name = `Server Basic` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1500.jpg`
        ...
        ( productid = `HT-1501` category = `Servers` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `25` weightunit = `KG`
          description = `Dual socket, quad-core processing server with 1644 MHz Front Side Bus with 10Gb connectivity` name = `Server Professional` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1501.jpg`
        ...
        ( productid = `HT-1502` category = `Servers` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `35` weightunit = `KG`
          description = `Dual socket, quad-core processing server with 1644 MHz Front Side Bus with 100Gb connectivity` name = `Server Power Pro` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1502.jpg`
        ...
        ( productid = `HT-1600` category = `Desktop Computers` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `4.8` weightunit = `KG`
          description = `2,8 Ghz dual core, 4 GB DDR3 SDRAM, 500 GB Hard Disc, Graphic Card: Proctra X, Windows 8` name = `Family PC Basic` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1600.jpg`
        ...
        ( productid = `HT-1601` category = `Desktop Computers` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `5.3` weightunit = `KG`
          description = `2,8 Ghz dual core, 4 GB DDR3 SDRAM, 1000 GB Hard Disc, Graphic Card: Gladiator MX, Windows 8` name = `Family PC Pro` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1601.jpg`
        ...
        ( productid = `HT-1602` category = `Desktop Computers` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `5.9` weightunit = `KG`
          description = `3,4 Ghz quad core, 8 GB DDR3 SDRAM, 2000 GB Hard Disc, Graphic Card: Gladiator MX, Windows 8` name = `Gaming Monster` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1602.jpg`
        ...
        ( productid = `HT-1603` category = `Desktop Computers` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `6.8` weightunit = `KG`
          description = `3,4 Ghz quad core, 16 GB DDR3 SDRAM, 4000 GB Hard Disc, Graphic Card: Hurricane GX, Windows 8` name = `Gaming Monster Pro` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-1603.jpg`
        ...
        ( productid = `HT-2000` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.79` weightunit = `KG` description = `7" LCD Screen, storage battery holds up to 6 hours!`
          name = `7" Widescreen Portable DVD Player w MP3` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-2000.jpg` status = `Available` quantity = 20 uom = `PC` currencycode = `EUR` price = `249.99` width = `21.4`
        ...
        ( productid = `HT-2001` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.84` weightunit = `KG` description = `10" LCD Screen, storage battery holds up to 8 hours`
          name = `10" Portable DVD player` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-2001.jpg` status = `Available` quantity = 21 uom = `PC` currencycode = `EUR` price = `449.99` width = `24` depth = `19.5`
        ...
        ( productid = `HT-2002` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `0.72` weightunit = `KG`
          description = `9" LCD Screen, storage holds up to 8 hours, 2 speakers included` name = `Portable DVD Player with 9" LCD Monitor` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-2002.jpg`
        ...
        ( productid = `HT-2025` category = `Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.65` weightunit = `KG` description = `Organizer and protective case for 264 CDs and DVDs`
          name = `CD/DVD case: 264 sleeves` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-2025.jpg` status = `Discontinued` quantity = 26 uom = `PC` currencycode = `EUR` price = `44.99` width = `13` depth = `13`
        ...
        ( productid = `HT-2026` category = `Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.2` weightunit = `KG` description = `Quality cables for notebooks and projectors`
          name = `Audio/Video Cable Kit - 4m` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-2026.jpg` status = `Available` quantity = 16 uom = `PC` currencycode = `EUR` price = `29.99` width = `21` depth = `10.2`
        ...
        ( productid = `HT-2027` category = `Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.15` weightunit = `KG` description = `Removable jewel case labels, zero residues (100)`
          name = `Removable CD/DVD Laser Labels` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-2027.jpg` status = `Discontinued` quantity = 25 uom = `PC` currencycode = `EUR` price = `8.99` width = `5.5`
        ...
        ( productid = `HT-6100` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `1.7` weightunit = `KG` description = `720p, DLP Projector max. 8,45 Meter, 2D`
          name = `Beam Breaker B-1` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6100.jpg` status = `Out of Stock` quantity = 32 uom = `PC` currencycode = `EUR` price = `469` width = `30.4` depth = `23.1`
          height = `23` dimunit = `cm` )
        ( productid = `HT-6101` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `2` weightunit = `KG` description = `1080p, DLP max.9,34 Meter, 2D-ready`
          name = `Beam Breaker B-2` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6101.jpg` status = `Available` quantity = 18 uom = `PC` currencycode = `EUR` price = `679` width = `30.4` depth = `23.1`
          height = `23` dimunit = `cm` )
        ( productid = `HT-6102` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Technocom` weightmeasure = `2.5` weightunit = `KG` description = `1080p, DLP max. 12,3 Meter, 3D-ready`
          name = `Beam Breaker B-3` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6102.jpg` status = `Out of Stock` quantity = 16 uom = `PC` currencycode = `EUR` price = `889` width = `30.4` depth = `23.1`
          height = `23` dimunit = `cm` )
        ( productid = `HT-6110` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `2.4` weightunit = `KG`
          description = `CD-RW, DVD+R/RW, DVD-R/RW, MPEG 2 (Video-DVD), MPEG 4, VCD, SVCD, DivX, Xvid` name = `Play Movie` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6110.jpg` status = `Available` quantity = 15
        ...
        ( productid = `HT-6111` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `3.1` weightunit = `KG`
          description = `160 GB HDD, CD-RW, DVD+R/RW, DVD-R/RW, MPEG 2 (Video-DVD), MPEG 4, VCD, SVCD, DivX, Xvid` name = `Record Movie` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6111.jpg`
        ...
        ( productid = `HT-6120` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `134` weightunit = `G` description = `64 GB USB Music-on-Available-Stick`
          name = `ITelo MusicStick` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6120.jpg` status = `Available` quantity = 15 uom = `PC` currencycode = `EUR` price = `45` width = `1.5` depth = `6` height = `1`
          dimunit = `cm` )
        ( productid = `HT-6121` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `134` weightunit = `G` description = `ITelo Jog-Mate 64 GB HDD and Color Display, can play movies`
          name = `ITelo Jog-Mate` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6121.jpg` status = `Available` quantity = 24 uom = `PC` currencycode = `EUR` price = `63` width = `5.1` depth = `8` height = `9.2`
          dimunit = `cm` )
        ( productid = `HT-6122` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `266` weightunit = `G`
          description = `MP3-Player with 40 GB HDD and Color Display, can play movies` name = `Power Pro Player 40` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6122.jpg` status = `Available` quantity = 23
        ...
        ( productid = `HT-6123` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `267` weightunit = `G`
          description = `MP3-Player with 80 GB SSD and Color Display, can play movies` name = `Power Pro Player 80` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6123.jpg` status = `Available` quantity = 13
        ...
        ( productid = `HT-6130` category = `Flat Screen TVs` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `2.6` weightunit = `KG` description = `32-inch, 1366x768 Pixel, 16:9, HDTV ready`
          name = `Flat Watch HD32` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6130.jpg` status = `Available` quantity = 16 uom = `PC` currencycode = `EUR` price = `1459` width = `78` depth = `22.1`
        ...
        ( productid = `HT-6131` category = `Flat Screen TVs` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `2.2` weightunit = `KG` description = `37-inch, 1366x768 Pixel, 16:9, HDTV ready`
          name = `Flat Watch HD37` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6131.jpg` status = `Available` quantity = 14 uom = `PC` currencycode = `EUR` price = `1199` width = `99.1` depth = `26`
        ...
        ( productid = `HT-6132` category = `Flat Screen TVs` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Very Best Screens` weightmeasure = `1.8` weightunit = `KG` description = `41-inch, 1366x768 Pixel, 16:9, HDTV ready`
          name = `Flat Watch HD41` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-6132.jpg` status = `Discontinued` quantity = 13 uom = `PC` currencycode = `EUR` price = `899` width = `128` depth = `23`
        ...
        ( productid = `HT-7000` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `0.5` weightunit = `KG`
          description = `Our new multifunctional Handheld with phone function in copper` name = `Copperberry` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-7000.jpg` status = `Discontinued` quantity = 5 uom = `PC`
        ...
        ( productid = `HT-7010` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `0.5` weightunit = `KG`
          description = `Our new multifunctional Handheld with phone function in silver` name = `Silverberry` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-7010.jpg` status = `Discontinued` quantity = 9 uom = `PC`
          currencycode = `EUR` price = `549` width = `8.1` depth = `13` height = `12.1` dimunit = `cm` )
        ( productid = `HT-7020` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `0.5` weightunit = `KG`
          description = `Our new multifunctional Handheld with phone function in gold` name = `Goldberry` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-7020.jpg` status = `Available` quantity = 11 uom = `PC`
          currencycode = `EUR` price = `549` width = `8.1` depth = `13` height = `12.1` dimunit = `cm` )
        ( productid = `HT-7030` category = `Accessories` maincategory = `Computer Components` taxtarifcode = `1` suppliername = `Fasttech` weightmeasure = `0.5` weightunit = `KG`
          description = `Our new multifunctional Handheld with phone function in platinum` name = `Platinberry` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-7030.jpg` status = `Available` quantity = 12 uom = `PC`
          currencycode = `EUR` price = `549` width = `8.1` depth = `13` height = `12.1` dimunit = `cm` )
        ( productid = `HT-8000` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `4` weightunit = `KG`
          description = `Notebook with 2,80 GHz dual core, 4 GB DDR3 SDRAM, 500 GB Hard Disc, Windows 8` name = `ITelO FlexTop I4000` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-8000.jpg` status = `Available`
        ...
        ( productid = `HT-8001` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `4.2` weightunit = `KG`
          description = `Notebook with 2,80 GHz dual core, 8 GB DDR3 SDRAM, 500 GB Hard Disc, Windows 8` name = `ITelO FlexTop I6300c` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-8001.jpg`
        ...
        ( productid = `HT-8002` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `3.5` weightunit = `KG`
          description = `Notebook with 2,80 GHz quad core, 4 GB DDR3 SDRAM, 1000 GB Hard Disc, Windows 8` name = `ITelO FlexTop I9100` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-8002.jpg` status = `Available`
        ...
        ( productid = `HT-8003` category = `Laptops` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `3.8` weightunit = `KG`
          description = `Notebook with 2,80 GHz quad core, 8 GB DDR3 SDRAM, 1000 GB Hard Disc, Windows 8` name = `ITelO FlexTop I9800` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-8003.jpg` status = `Available`
        ...
        ( productid = `HT-9991` category = `Accessories` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `0.02` weightunit = `KG`
          description = `Button Clasp, Quality Material, 100% Leather, compatible with many smartphone models` name = `Smartphone Leather Case` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9991.jpg`
        ...
        ( productid = `HT-9992` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `0.75` weightunit = `KG`
          ...
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9992.jpg` status = `Out of Stock` quantity = 13 uom = `PC` currencycode = `EUR` price = `599` width = `48` depth = `31` height = `4.5` dimunit = `cm` )
        ( productid = `HT-9993` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `3.8` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9993.jpg` status = `Available` quantity = 10 uom = `PC` currencycode = `EUR` price = `833` width = `48` depth = `31` height = `4.5` dimunit = `cm` )
        ( productid = `HT-9994` category = `Accessories` maincategory = `TV, Video & HiFi` taxtarifcode = `1` suppliername = `Ultrasonic United` weightmeasure = `3.8` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9994.jpg` status = `Out of Stock` quantity = 50 uom = `PC` currencycode = `EUR` price = `1388` width = `48` depth = `31` height = `27` dimunit = `cm` )
        ( productid = `HT-9995` category = `Accessories` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.03` weightunit = `KG`
          description = `Stylish tablet pouch, protects from scratches, color: black` name = `Tablet Pouch` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9995.jpg` status = `Available` quantity = 34 uom = `PC`
        ...
        ( productid = `HT-9996` category = `Accessories` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.03` weightunit = `KG`
          description = `Stylish tablet pouch, protects from scratches, color: black` name = `Tablet Pouch` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9996.jpg` status = `Available` quantity = 34 uom = `PC`
          currencycode = `EUR` price = `20` width = `25` depth = `40` height = `4.5` dimunit = `cm` )
        ( productid = `HT-9997` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `3.8` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9997.jpg` status = `Available` quantity = 23 uom = `PC` currencycode = `EUR` price = `33` width = `48` depth = `31` height = `4.5` dimunit = `cm` )
        ( productid = `HT-9998` category = `Smartphones and Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.75` weightunit = `KG`
          description = `5 Megapixel Camera, Wi-Fi 802.11 b/g/n, Bluetooth, GPS Available-GPS support` name = `Smartphone Beta` dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9998.jpg` status = `Available`
        ...
        ( productid = `HT-9999` category = `Tablets` maincategory = `Smartphones & Tablets` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `3.8` weightunit = `KG`
          ...
          productpicurl = `test-resources/sap/ui/documentation/sdk/images/HT-9999.jpg` status = `Available` quantity = 20 uom = `PC` currencycode = `EUR` price = `749` width = `48` depth = `31` height = `4.5` dimunit = `cm` )
        ( productid = `PF-1000` category = `Accessories` maincategory = `Computer Systems` taxtarifcode = `1` suppliername = `Titanium` weightmeasure = `0.01` weightunit = `KG` description = `Flyer for our product palette` name = `Flyer`
          dateofsale = `` productpicurl = `test-resources/sap/ui/documentation/sdk/images/PF-1000.jpg` status = `Out of Stock` quantity = 33 uom = `PC` currencycode = `EUR` price = `0` width = `46` depth = `30` height = `3` dimunit = `cm` )
    ).
