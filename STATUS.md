...
| Aspect | State |
|---|---|
| Ports | **310** sidecars in `meta/` (src/01: 181 · src/02: 75 · src/03: 19 · src/04: 19 · src/05: 16) |
| Status ladder | 103 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 39 IMPROVISED · 13 LIVE_TEST · 639 NOTE · 140 POST_171 |
