...
| Aspect | State |
|---|---|
| Ports | **273** sidecars in `meta/` (src/01: 160 · src/02: 65 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 76 `generated` · 146 `reviewed` · 51 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 131 IMPROVISED · 48 LIVE_TEST · 370 NOTE · 110 POST_171 |
