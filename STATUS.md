...
| Aspect | State |
|---|---|
| Ports | **269** sidecars in `meta/` (src/01: 158 · src/02: 63 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 72 `generated` · 146 `reviewed` · 51 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 130 IMPROVISED · 58 LIVE_TEST · 342 NOTE · 109 POST_171 |
| Open LIVE_TESTs | **56 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
