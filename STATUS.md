...
| Aspect | State |
|---|---|
| Ports | **484** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 340 · src/02 OpenUI5 > 1.71: 144) |
| Per library | sap.f: 21 · sap.m: 285 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 68 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 72 IMPROVISED · 16 LIVE_TEST · 1115 NOTE · 212 POST_171 |
| Open LIVE_TESTs | **16 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
