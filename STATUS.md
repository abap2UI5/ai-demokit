...
| Aspect | State |
|---|---|
| Ports | **484** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 339 · src/02 OpenUI5 > 1.71: 145) |
...
| Deviations | 5 DROPPED_171 · 74 IMPROVISED · 20 LIVE_TEST · 1126 NOTE · 213 POST_171 |
| Open LIVE_TESTs | **20 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
