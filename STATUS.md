...
| Aspect | State |
|---|---|
| Ports | **267** sidecars in `meta/` (src/01: 158 · src/02: 61 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 70 `generated` · 146 `reviewed` · 51 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 127 IMPROVISED · 56 LIVE_TEST · 339 NOTE · 109 POST_171 |
