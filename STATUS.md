...
| Deviations | 4 DROPPED_171 · 131 IMPROVISED · 45 LIVE_TEST · 384 NOTE · 110 POST_171 |
| Open LIVE_TESTs | **44 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
