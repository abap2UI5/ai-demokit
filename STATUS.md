...
| Aspect | State |
|---|---|
| Ports | **251** sidecars in `meta/` (src/01: 153 · src/02: 56 · src/03: 12 · src/04: 19 · src/05: 11) |
| Status ladder | 54 `generated` · 146 `reviewed` · 51 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 118 IMPROVISED · 54 LIVE_TEST · 310 NOTE · 99 POST_171 |
