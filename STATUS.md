...
| Aspect | State |
|---|---|
| Ports | **252** sidecars in `meta/` (src/01: 154 · src/02: 56 · src/03: 12 · src/04: 19 · src/05: 11) |
| Status ladder | 55 `generated` · 146 `reviewed` · 51 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 118 IMPROVISED · 55 LIVE_TEST · 311 NOTE · 99 POST_171 |
| Open LIVE_TESTs | **52 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
