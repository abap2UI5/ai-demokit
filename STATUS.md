...
| Aspect | State |
|---|---|
| Ports | **405** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 282 · src/02 OpenUI5 > 1.71: 123) |
| Per library | sap.f: 19 · sap.m: 219 · sap.tnt: 16 · sap.ui: 130 · sap.uxap: 21 |
| Status ladder | 198 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 58 IMPROVISED · 62 LIVE_TEST · 854 NOTE · 162 POST_171 |
