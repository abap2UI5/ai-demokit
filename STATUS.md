...
| Aspect | State |
|---|---|
| Ports | **473** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 329 · src/02 OpenUI5 > 1.71: 144) |
| Per library | sap.f: 21 · sap.m: 274 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 57 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 72 IMPROVISED · 29 LIVE_TEST · 1102 NOTE · 212 POST_171 |
| Open LIVE_TESTs | **29 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
