...
| Aspect | State |
|---|---|
| Ports | **584** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 389 · src/02 OpenUI5 > 1.71: 195) |
| Per library | sap.f: 36 · sap.m: 370 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 168 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 9 DROPPED_171 · 110 IMPROVISED · 98 LIVE_TEST · 1499 NOTE · 263 POST_171 |
| Open LIVE_TESTs | **98 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
