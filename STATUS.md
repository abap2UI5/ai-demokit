...
| Aspect | State |
|---|---|
| Ports | **406** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 282 · src/02 OpenUI5 > 1.71: 124) |
| Per library | sap.f: 19 · sap.m: 219 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 21 |
| Status ladder | 199 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 60 IMPROVISED · 63 LIVE_TEST · 859 NOTE · 164 POST_171 |
