...
| Aspect | State |
|---|---|
| Ports | **289** sidecars in `meta/` (src/01: 174 · src/02: 67 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 82 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 134 IMPROVISED · 37 LIVE_TEST · 432 NOTE · 120 POST_171 |
