...
| Deviations | 4 DROPPED_171 · 47 IMPROVISED · 566 NOTE · 121 POST_171 |
...
- [ ] **IMPROVISED harvest — all 6 requests implemented, probes measured**
  ...
  | REWORK | 16 | 10 | expressible today; the port under-delivers (review backlog) |
  ...
  is lost or substituted — and the count reads **47** instead of 136.
