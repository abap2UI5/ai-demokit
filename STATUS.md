...
| Status ladder | 48 `generated` · 145 `reviewed` · 53 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 131 IMPROVISED · 70 LIVE_TEST · 253 NOTE · 95 POST_171 |
| Open LIVE_TESTs | **66 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
