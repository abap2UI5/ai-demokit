...
| Aspect | State |
|---|---|
| Ports | **437** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 301 · src/02 OpenUI5 > 1.71: 136) |
| Per library | sap.f: 19 · sap.m: 240 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 21 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 68 IMPROVISED · 15 LIVE_TEST · 1055 NOTE · 203 POST_171 |
| Open LIVE_TESTs | **15 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
