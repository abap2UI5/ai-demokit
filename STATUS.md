...
| Aspect | State |
|---|---|
| Ports | **575** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 387 · src/02 OpenUI5 > 1.71: 188) |
| Per library | sap.f: 27 · sap.m: 370 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 159 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 7 DROPPED_171 · 108 IMPROVISED · 90 LIVE_TEST · 1438 NOTE · 256 POST_171 |
| Open LIVE_TESTs | **90 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
