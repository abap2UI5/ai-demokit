...
| Aspect | State |
|---|---|
| Ports | **270** sidecars in `meta/` (src/01: 158 · src/02: 64 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 73 `generated` · 146 `reviewed` · 51 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 131 IMPROVISED · 59 LIVE_TEST · 346 NOTE · 109 POST_171 |
| Open LIVE_TESTs | **57 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
