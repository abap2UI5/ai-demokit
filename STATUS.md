...
| Aspect | State |
|---|---|
| Ports | **297** sidecars in `meta/` (src/01: 181 · src/02: 67 · src/03: 19 · src/04: 19 · src/05: 11) |
| Status ladder | 90 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 31 IMPROVISED · 610 NOTE · 125 POST_171 |
