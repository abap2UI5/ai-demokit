...
| Aspect | State |
|---|---|
| Ports | **514** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 360 · src/02 OpenUI5 > 1.71: 154) |
| Per library | sap.f: 21 · sap.m: 315 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 98 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 79 IMPROVISED · 30 LIVE_TEST · 1184 NOTE · 222 POST_171 |
| Open LIVE_TESTs | **30 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
