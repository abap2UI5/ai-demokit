...
| Deviations | 11 DROPPED_171 · 164 IMPROVISED · 3 LIVE_TEST · 1869 NOTE · 292 POST_171 |
| Open LIVE_TESTs | **3 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
