...
| Aspect | State |
|---|---|
| Ports | **463** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 320 · src/02 OpenUI5 > 1.71: 143) |
| Per library | sap.f: 21 · sap.m: 264 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 47 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 70 IMPROVISED · 28 LIVE_TEST · 1096 NOTE · 211 POST_171 |
| Open LIVE_TESTs | **28 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
