...
| Aspect | State |
|---|---|
| Ports | **254** sidecars in `meta/` (src/01: 156 · src/02: 56 · src/03: 12 · src/04: 19 · src/05: 11) |
| Status ladder | 57 `generated` · 146 `reviewed` · 51 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 118 IMPROVISED · 55 LIVE_TEST · 315 NOTE · 99 POST_171 |
