...
| Aspect | State |
|---|---|
| Ports | **494** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 344 · src/02 OpenUI5 > 1.71: 150) |
| Per library | sap.f: 21 · sap.m: 295 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 78 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 75 IMPROVISED · 13 LIVE_TEST · 1150 NOTE · 218 POST_171 |
| Open LIVE_TESTs | **13 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
