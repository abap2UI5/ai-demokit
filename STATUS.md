...
| Aspect | State |
|---|---|
| Ports | **288** sidecars in `meta/` (src/01: 173 · src/02: 67 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 81 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 134 IMPROVISED · 37 LIVE_TEST · 429 NOTE · 120 POST_171 |
