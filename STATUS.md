...
| Aspect | State |
|---|---|
| Ports | **429** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 295 · src/02 OpenUI5 > 1.71: 134) |
| Per library | sap.f: 19 · sap.m: 232 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 13 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 66 IMPROVISED · 9 LIVE_TEST · 1042 NOTE · 201 POST_171 |
| Open LIVE_TESTs | **9 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
