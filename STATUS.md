...
| Aspect | State |
|---|---|
| Ports | **416** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 290 · src/02 OpenUI5 > 1.71: 126) |
| Per library | sap.f: 19 · sap.m: 219 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 153 `generated` · 202 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 66 IMPROVISED · 6 LIVE_TEST · 975 NOTE · 184 POST_171 |
