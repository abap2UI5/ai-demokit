...
| Aspect | State |
|---|---|
| Ports | **544** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 374 · src/02 OpenUI5 > 1.71: 170) |
| Per library | sap.f: 25 · sap.m: 341 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 128 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 94 IMPROVISED · 59 LIVE_TEST · 1281 NOTE · 238 POST_171 |
| Open LIVE_TESTs | **59 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
