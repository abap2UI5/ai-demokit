...
| Aspect | State |
|---|---|
| Ports | **282** sidecars in `meta/` (src/01: 167 · src/02: 67 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 73 `generated` · 146 `reviewed` · 63 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 132 IMPROVISED · 35 LIVE_TEST · 411 NOTE · 117 POST_171 |
