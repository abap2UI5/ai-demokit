...
| Aspect | State |
|---|---|
| Ports | **302** sidecars in `meta/` (src/01: 181 · src/02: 67 · src/03: 19 · src/04: 19 · src/05: 16) |
| Status ladder | 95 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 34 IMPROVISED · 5 LIVE_TEST · 625 NOTE · 137 POST_171 |
| Open LIVE_TESTs | **5 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
