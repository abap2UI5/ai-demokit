...
| Aspect | State |
|---|---|
| Ports | **610** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 399 · src/02 OpenUI5 > 1.71: 211) |
| Per library | sap.f: 36 · sap.m: 381 · sap.tnt: 17 · sap.ui: 131 · sap.uxap: 45 |
| Status ladder | 194 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 12 DROPPED_171 · 130 IMPROVISED · 111 LIVE_TEST · 1603 NOTE · 281 POST_171 |
| Open LIVE_TESTs | **111 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
