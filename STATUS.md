...
| Aspect | State |
|---|---|
| Ports | **445** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 306 · src/02 OpenUI5 > 1.71: 139) |
| Per library | sap.f: 19 · sap.m: 248 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 29 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 68 IMPROVISED · 19 LIVE_TEST · 1073 NOTE · 207 POST_171 |
| Open LIVE_TESTs | **19 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
