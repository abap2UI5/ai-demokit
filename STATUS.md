...
| Aspect | State |
|---|---|
| Ports | **453** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 311 · src/02 OpenUI5 > 1.71: 142) |
| Per library | sap.f: 21 · sap.m: 254 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 31 |
| Status ladder | 37 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 70 IMPROVISED · 27 LIVE_TEST · 1094 NOTE · 210 POST_171 |
| Open LIVE_TESTs | **27 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
