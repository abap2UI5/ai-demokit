...
| Aspect | State |
|---|---|
| Ports | **375** sidecars in `meta/` (src/01: 191 · src/02: 130 · src/03: 19 · src/04: 19 · src/05: 16) |
| Status ladder | 168 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 57 IMPROVISED · 61 LIVE_TEST · 830 NOTE · 153 POST_171 |
