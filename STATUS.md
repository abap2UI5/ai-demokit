...
| Aspect | State |
|---|---|
| Ports | **290** sidecars in `meta/` (src/01: 175 · src/02: 67 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 83 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 135 IMPROVISED · 37 LIVE_TEST · 435 NOTE · 121 POST_171 |
