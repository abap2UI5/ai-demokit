...
| Aspect | State |
|---|---|
| Ports | **313** sidecars in `meta/` (src/01: 181 · src/02: 78 · src/03: 19 · src/04: 19 · src/05: 16) |
| Status ladder | 106 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 39 IMPROVISED · 16 LIVE_TEST · 649 NOTE · 140 POST_171 |
