...
| Aspect | State |
|---|---|
| Ports | **622** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 404 · src/02 OpenUI5 > 1.71: 218) |
...
| Deviations | 11 DROPPED_171 · 165 IMPROVISED · 122 LIVE_TEST · 1713 NOTE · 291 POST_171 |
| Open LIVE_TESTs | **122 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
