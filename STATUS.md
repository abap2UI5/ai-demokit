...
| Aspect | State |
|---|---|
| Ports | **283** sidecars in `meta/` (src/01: 168 · src/02: 67 · src/03: 18 · src/04: 19 · src/05: 11) |
| Status ladder | 74 `generated` · 146 `reviewed` · 63 `checked` (live-verified) |
| Deviations | 4 DROPPED_171 · 132 IMPROVISED · 35 LIVE_TEST · 415 NOTE · 117 POST_171 |
