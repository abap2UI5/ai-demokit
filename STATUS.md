...
| Deviations | 5 DROPPED_171 · 66 IMPROVISED · 26 LIVE_TEST · 934 NOTE · 173 POST_171 |
| Open LIVE_TESTs | **26 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
