...
| Aspect | State |
|---|---|
| Ports | **336** sidecars in `meta/` (src/01: 181 · src/02: 101 · src/03: 19 · src/04: 19 · src/05: 16) |
| Status ladder | 129 `generated` · 146 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 5 DROPPED_171 · 39 IMPROVISED · 39 LIVE_TEST · 747 NOTE · 140 POST_171 |
