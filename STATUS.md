...
| Aspect | State |
|---|---|
| Ports | **598** sidecars in `meta/` (src/01 OpenUI5 <= 1.71: 394 · src/02 OpenUI5 > 1.71: 204) |
| Per library | sap.f: 36 · sap.m: 370 · sap.tnt: 17 · sap.ui: 130 · sap.uxap: 45 |
| Status ladder | 182 `generated` · 355 `reviewed` · 61 `checked` (live-verified) |
| Deviations | 11 DROPPED_171 · 123 IMPROVISED · 104 LIVE_TEST · 1552 NOTE · 274 POST_171 |
| Open LIVE_TESTs | **104 ports** carry at least one `LIVE_TEST` deviation — the automated close path is the e2e interaction harness (AGENTS §6 `e2e_smoke`) |
