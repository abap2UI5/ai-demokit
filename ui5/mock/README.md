...
- `products.json` — `ProductCollection` (123 products, upstream order) and
  ...
  `src/01/b01/z2ui5_cl_api_app_440.clas.abap`, and the name/quantity rows of
  `src/01/b04/z2ui5_cl_api_app_433.clas.abap`; the stats `SupplierName` group
...
- `countriesExtendedCollection.json` — `CountriesCollection` (70 countries),
  ...
  `src/01/b02/z2ui5_cl_api_app_423.clas.abap`. Used by the ComboBox samples.
