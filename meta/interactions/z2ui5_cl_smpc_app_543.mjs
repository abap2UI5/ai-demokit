...
export default async (page, expect) => {
  ...
  // both Selects share their key with the calendar
  await waitForUi5(page, () => ui5All().some((c) => c.getMetadata().getName() === 'sap.m.PlanningCalendar'
    && c.getAppointmentHeight() === 'Regular' && c.getAppointmentRoundWidth() === 'None'),
    'the two appointment-size keys never reached the calendar');
};
