...
export default async (page, expect) => {
  ...
  // the two calendar-type Selects share their key with the calendar
  await waitForUi5(page, () => ui5All().some((c) => c.getMetadata().getName() === 'sap.m.PlanningCalendar'
    && c.getPrimaryCalendarType() === 'Gregorian'), 'the primary calendar type never reached the calendar');
};
