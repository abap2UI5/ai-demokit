...
See [COVERAGE.md](COVERAGE.md) for every UI5 demo kit sample per library,
marked ✅ ported / ❌ missing, with a coverage figure per module. It is
regenerated by the `generate_coverage` workflow (`scripts/generate-coverage.mjs`)
from the latest OpenUI5 demo kit samples.
