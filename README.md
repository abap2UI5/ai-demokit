...
| [`pr/`](pr) | The record of what porting asked the framework for — implemented and declined. Open requests moved to [`vorrat/`](https://github.com/abap2UI5/abap2UI5/tree/main/vorrat) in abap2UI5, where the whole ecosystem's upstream backlog lives |
